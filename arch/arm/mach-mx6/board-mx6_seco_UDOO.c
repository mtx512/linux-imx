...
{
	if (cpu_is_mx6q())
		mxc_iomux_v3_setup_multiple_pads(mx6q_udoo_hdmi_ddc_pads,
			ARRAY_SIZE(mx6q_udoo_hdmi_ddc_pads));
}

static void hdmi_disable_ddc_pin(void)
{
	if (cpu_is_mx6q())
		mxc_iomux_v3_setup_multiple_pads(mx6q_udoo_i2c2_pads,
			ARRAY_SIZE(mx6q_udoo_i2c2_pads));
}
