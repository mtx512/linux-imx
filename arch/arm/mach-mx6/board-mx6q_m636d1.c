...
#include "board-mx6q_m636d1.h"
#include "board-mx6dl_sabresd.h"
//#include <pad6/honmax_keys.h>
//#include <pad6/pad6_battery.h>
//#include <pad6/pad6.h>
...
#else
#define SABRESD_VOLUME_UP	IMX_GPIO_NR(3, 16)
#define SABRESD_VOLUME_DN	IMX_GPIO_NR(1, 5)
#endif
...
#ifndef CONFIG_LENS_AN41908A  //add by tianfeng
#define SABRESD_DISP0_PWR_EN	IMX_GPIO_NR(1, 30)
#endif


//#define SABRESD_SD3_CD		IMX_GPIO_NR(5, 15)
#define SABRESD_SD3_CD		IMX_GPIO_NR(5, 11)
...
#define SABRESD_AUX_5V_EN	IMX_GPIO_NR(6, 10) /*PAD6 use this pin to control PMIC_5V*/
#ifndef  CONFIG_LENS_AN41908A
...
#ifdef CONFIG_LENS_AN41908A  //add by tianfeng
...
#if 0 //--->M2031
/*Add by ljc for charger ctrl*/
#define HONMAX_DC_DETECT	                          	IMX_GPIO_NR(2, 24)
#define HONMAX_LOW_POWER	 				IMX_GPIO_NR(4, 7)
#define HONMAX_CHARG_STATE_FULL_POWER 	IMX_GPIO_NR(3, 23)
#define HONMAX_MAX8903_CHARG_EN               	IMX_GPIO_NR(2, 0)
#define HONMAX_USB_CHARG_CTRL	  			IMX_GPIO_NR(4, 14)
#define HONMAX_MAX8903_CHARG_CTRL1	  	IMX_GPIO_NR(6, 8)
#define HONMAX_MAX8903_CHARG_CTRL2	  	IMX_GPIO_NR(6, 16)
#endif 

/*===================USB===========================*/
#define SABRESD_USB_OTG_PWR				IMX_GPIO_NR(4, 30)
//#define HONMAX_OTG_VBUS_CRTL			IMX_GPIO_NR(5, 14)
#define HONMAX_OTG_VBUS_CRTL			IMX_GPIO_NR(5, 12)

#define HONMAX_OTG_ID_EN				IMX_GPIO_NR(5, 8)
//#define SABRESD_USB_H1_PWR				IMX_GPIO_NR(1, 18)
#define SABRESD_USB_H1_PWR				IMX_GPIO_NR(7, 0)


#define HONMAX_USB4_PWR_EN  			IMX_GPIO_NR(4, 10)
#define HONMAX_USB2_PWR_EN  			IMX_GPIO_NR(4, 26)

/*===================AUDIO=========================*/

//#define SABRESD_CODEC_PWR_EN			IMX_GPIO_NR(4, 21)
#define SABRESD_CODEC_PWR_EN			IMX_GPIO_NR(6, 3)

#define SABRESD_HEADPHONE_DET			IMX_GPIO_NR(4, 18)
#define SABRESD_MIC_DET					IMX_GPIO_NR(7, 8)



/*Add by ljc for Wifi Power Ctrl*/
#define HONMAX_WIFI_PWR_EN			IMX_GPIO_NR(4, 29)
#define HONMAX_WIFI_PWR_IO_EN		IMX_GPIO_NR(5, 5)
#define HONMAX_WIFI_PND				IMX_GPIO_NR(4, 28)

/*Add by ljc for LCD BackLight Ctrl*/
#define HONMAX_LCD_3V3_ON          			IMX_GPIO_NR(4, 15)

/*Add by ljc for TP Ctrl*/
#define HONMAX_TP_INT					IMX_GPIO_NR(6, 7)
//#define HONMAX_TP_RST					IMX_GPIO_NR(5, 14)
#define HONMAX_TP_PWR_EN				IMX_GPIO_NR(3, 15)

/*Add by ljc for HDMI Ctrl*/
//#define HONMAX_HDMI_PORT_EN  			IMX_GPIO_NR(1, 1)

/*Add by ljc for G-sensor Ctrl, actually we never use it*/
//#define HONMAX_G_SENSOR_INT			IMX_GPIO_NR(1, 18)


/*Add by ljc for PA206 Ctrl*/
#if 0 //---->M2031
#define HONMAX_NOTE_REBOOT 			IMX_GPIO_NR(3,21)
#else
#define HONMAX_NOTE_REBOOT 			IMX_GPIO_NR(3,31)
#endif
#define HONMAX_LOCK_POWER				IMX_GPIO_NR(3, 30)

/*Add by ljc for PMIC_5V Ctrl*/
#define HONMAX_PMIC_5V_EN				IMX_GPIO_NR(6, 10)

/*Watch Dog Pin*/
#if 1 //------->M2031
#define HONMAX_WATCHDOG	  			IMX_GPIO_NR(6, 8)
#define HONMAX_NOTE_PA306_WATCHDOG	IMX_GPIO_NR(5, 2)
#endif

#ifdef CONFIG_LENS_AN41908A  //add by tianfeng
#define SABRESD_AN41908A_FOCUS_PI_OUT IMX_GPIO_NR(4, 28)
#define SABRESD_AN41908A_ZOOM_PI_OUT IMX_GPIO_NR(6, 31)
#define SABRESD_AN41908A_MOTOR_RST IMX_GPIO_NR(1, 30)
#define SABRESD_AN41908A_VD_FZ IMX_GPIO_NR(6, 14)
#define SABRESD_AN41908A_VD_IS IMX_GPIO_NR(2, 24)
//#define SABRESD_AN41908A_LENS_IO6 IMX_GPIO_NR(2, 23)
#define SABRESD_AN41908A_LENS_IO6 IMX_GPIO_NR(6, 15)

#endif

#define HONMAX_LED_2				IMX_GPIO_NR(5, 30)
#define HONMAX_LED_1				IMX_GPIO_NR(5, 31)

static struct clk *sata_clk;
static struct clk *clko;
static int mma8451_position = 6;
static int mma8452_position = 1;
...
#if 0
static const struct esdhc_platform_data mx6q_m636d1_sd2_data __initconst = {
...
static const struct esdhc_platform_data mx6q_m636d1_sd3_data __initconst = {
	.cd_gpio = SABRESD_SD3_CD,
	.wp_gpio = -EINVAL,//SABRESD_SD3_WP,
	.keep_power_at_suspend = 1,
	.support_8bit = 0,
	.delay_line = 0,
	.cd_type = ESDHC_CD_CONTROLLER,
...
static const struct esdhc_platform_data mx6q_m636d1_sd4_data __initconst = {
	.always_present = 1,
	.keep_power_at_suspend = 1,
	.support_8bit = 1,
	.delay_line = 0,
...
static const struct anatop_thermal_platform_data
	mx6q_m636d1_anatop_thermal_data __initconst = {
		.name = "anatop_thermal",
};

/*Add by ljc for note PA206 that PAD6 will reboot*/
extern void (*pad6_prep_restart)(void);
static void pad6_note_reboot(void)
{
	int block,nr,reg;
	block=(HONMAX_NOTE_REBOOT)/32;
	nr=(HONMAX_NOTE_REBOOT)%32;
	reg = __raw_readl(GPIO1_BASE_ADDR + block*0x4000);
	reg &=(~(1<<nr));
	__raw_writel(reg, GPIO1_BASE_ADDR + block*0x4000);
	mdelay(800); //800ms
	reg |=(1<<nr);
	__raw_writel(reg, GPIO1_BASE_ADDR + block*0x4000);
}
...
static inline void lens_an41908a_init(void){
	gpio_request(SABRESD_AN41908A_FOCUS_PI_OUT, "focus_pi_out");
	gpio_direction_input(SABRESD_AN41908A_FOCUS_PI_OUT);

	gpio_request(SABRESD_AN41908A_ZOOM_PI_OUT, "zoom_pi_out");
	gpio_direction_input(SABRESD_AN41908A_ZOOM_PI_OUT);


	gpio_request(SABRESD_AN41908A_MOTOR_RST, "motor_rst");
	gpio_direction_output(SABRESD_AN41908A_MOTOR_RST, 0);
	msleep(100);
	gpio_set_value(SABRESD_AN41908A_MOTOR_RST, 1);

	gpio_request(SABRESD_AN41908A_VD_FZ, "vdd_fz");
	gpio_direction_output(SABRESD_AN41908A_VD_FZ, 0);

	gpio_request(SABRESD_AN41908A_VD_IS, "vd_is");
	gpio_direction_output(SABRESD_AN41908A_VD_IS, 0);

	gpio_request(SABRESD_AN41908A_LENS_IO6, "lens_io6");
	gpio_direction_output(SABRESD_AN41908A_LENS_IO6, 1);
...
/*Add here end*/
/*Add by ljc for Honmax GPIO common init*/
static void honmax_gpio_init(void)
{
	gpio_request(HONMAX_USB4_PWR_EN, "usb4");
	gpio_direction_output(HONMAX_USB4_PWR_EN,1);
	gpio_request(HONMAX_USB2_PWR_EN, "usb2");
	gpio_direction_output(HONMAX_USB2_PWR_EN,1);
	/*wifi init*/
#if 1	
	gpio_request(HONMAX_WIFI_PWR_EN, "wifi_power_en");
	gpio_request(HONMAX_WIFI_PWR_IO_EN, "wifi_io_power_en");
	gpio_request(HONMAX_WIFI_PND, "wifi_pnd");
	gpio_direction_output(HONMAX_WIFI_PWR_EN,0);
	gpio_direction_output(HONMAX_WIFI_PWR_IO_EN,0);
	gpio_direction_output(HONMAX_WIFI_PND,0);
	msleep(10);
	gpio_set_value(HONMAX_WIFI_PWR_IO_EN,1);
	gpio_set_value(HONMAX_WIFI_PWR_EN,1);
	msleep(20);
	gpio_set_value(HONMAX_WIFI_PND,1);
#else 
	gpio_request(HONMAX_WIFI_3_3V_EN, "wifi_3_3v_en");
	gpio_request(HONMAX_WIFI_1_8V_EN, "wifi_1_8v_en");
	gpio_request(HONMAX_WIFI_PND, "wifi_pnd");
	gpio_direction_output(HONMAX_WIFI_3_3V_EN,0);
	gpio_set_value(HONMAX_WIFI_3_3V_EN,1);
	gpio_direction_output(HONMAX_WIFI_1_8V_EN,0);
	gpio_set_value(HONMAX_WIFI_1_8V_EN,1);
	msleep(50);
	gpio_direction_output(HONMAX_WIFI_PND,0);
	gpio_set_value(HONMAX_WIFI_PND,1);
#endif
#if 0
	/*LCD 3V3 init*/
	gpio_request(HONMAX_LCD_3V3_ON, "lcd-3v3-on");
	gpio_direction_output(HONMAX_LCD_3V3_ON, 1);

	/*TP ctrl pin init*/
	gpio_request(HONMAX_TP_INT, "tp-int");
	gpio_direction_input(HONMAX_TP_INT);
	//gpio_request(HONMAX_TP_RST, "tp-rst");
	//gpio_direction_output(HONMAX_TP_RST, 1);
	gpio_request(HONMAX_TP_PWR_EN, "tp-pwr-en");
	gpio_direction_output(HONMAX_TP_PWR_EN, 1);

	/*HDMI PORT Chip init*/
	//gpio_request(HONMAX_HDMI_PORT_EN, "hdmi-port-en");
	//gpio_direction_output(HONMAX_HDMI_PORT_EN,1); 

	/*G-Sensor INT pin init*/
//	gpio_request(HONMAX_G_SENSOR_INT,"g-sensor-int");
//	gpio_direction_input(HONMAX_G_SENSOR_INT);  /*actually we never use it*/

	/*PA206 Reboot and Lock Power pin init*/
	gpio_request(HONMAX_NOTE_REBOOT, "note_reboot");
	gpio_direction_output(HONMAX_NOTE_REBOOT,1);
	pad6_prep_restart=pad6_note_reboot;
	gpio_request(HONMAX_LOCK_POWER,"lock_power");
	gpio_direction_output(HONMAX_LOCK_POWER,1);

	/*Watch Dog Pin init*/
#if 1//------->M2031
	gpio_request(HONMAX_WATCHDOG, "watchdog");
	gpio_direction_output(HONMAX_WATCHDOG,0);
	gpio_request(HONMAX_NOTE_PA306_WATCHDOG,"watch_pa306");
	gpio_direction_output(HONMAX_NOTE_PA306_WATCHDOG,0);
#endif
#endif
}
/*Add here end*/

/***********Add by ljc for lcd-3v3-on Ctrl**************/
 static void honmax_lcd_3v3_on(bool on)
{
	static int old_state=-1;
	if(on && old_state!=1)
	{
		gpio_set_value(HONMAX_LCD_3V3_ON,1);
		old_state=1;
	}
	else if(!on && old_state!=0)
	{
		gpio_set_value(HONMAX_LCD_3V3_ON,0);
		old_state=0;
	}
}
/*******************add here end******************/
...
/***************Add by ljc for TP Ctrl****************/
/*static struct honmax_tp_data tp_data=
{
	.tp_int_gpio = HONMAX_TP_INT,
	//.tp_rst_gpio = HONMAX_TP_RST,
	.tp_pwr_en_gpio = HONMAX_TP_PWR_EN,
};*/
/*******************add here end******************/
/***************Add by ljc for HDMI Ctrl***************/
static void honmax_hdmi_port_en(bool on)
{
//	if(on)
//		gpio_set_value(HONMAX_HDMI_PORT_EN,1);
//	else
//		gpio_set_value(HONMAX_HDMI_PORT_EN,0);
}
/*******************add here end******************/

/*******Add by ljc for watch pa306(watch dog)**********/
static unsigned int watch_pin=HONMAX_NOTE_PA306_WATCHDOG;
static struct platform_device watch_pa306_dev = {
	.name	= "watch_pa306",
	.id	= 1,
	.dev	= {
		.platform_data = &watch_pin,
	},
};
/***********************************************/

#ifdef CONFIG_MXC_PXP_CLIENT_DEVICE
static struct platform_device pxp_client_dev = {
	.name	= "imx-pxp-client",
	.id	= 1,
};
#endif

static inline void mx6q_m636d1_init_uart(void)
{
	imx6q_add_imx_uart(2, NULL);
	imx6q_add_imx_uart(0, NULL);
	imx6q_add_imx_uart(1, NULL); //----->M2031
	imx6q_add_imx_uart(3, NULL);
}

static int mx6q_m636d1_fec_phy_init(struct phy_device *phydev)
{
	unsigned short val;
...
static struct fec_platform_data fec_data __initdata = {
	.init = mx6q_m636d1_fec_phy_init,
	.phy = PHY_INTERFACE_MODE_RGMII,
};

static int mx6q_m636d1_spi_cs[] = {
	SABRESD_ECSPI1_CS0,
};

static const struct spi_imx_master mx6q_m636d1_spi_data __initconst = {
	.chipselect     = mx6q_m636d1_spi_cs,
	.num_chipselect = ARRAY_SIZE(mx6q_m636d1_spi_cs),
};

#if defined(CONFIG_MTD_M25P80) || defined(CONFIG_MTD_M25P80_MODULE)
static struct mtd_partition imx6_m636d1_spi_nor_partitions[] = {
	{
	 .name = "bootloader",
	 .offset = 0,
	 .size = 0x00100000,
...
static struct flash_platform_data imx6_m636d1__spi_flash_data = {
	.name = "m25p80",
	.parts = imx6_m636d1_spi_nor_partitions,
	.nr_parts = ARRAY_SIZE(imx6_m636d1_spi_nor_partitions),
	.type = "sst25vf016b",
};
#endif

static struct spi_board_info imx6_m636d1_spi_nor_device[] __initdata = {
#if defined(CONFIG_MTD_M25P80)
	{
		...
		.bus_num = 0,
		.chip_select = 0,
		.platform_data = &imx6_m636d1__spi_flash_data,
	},
#endif
};

#ifdef CONFIG_LENS_AN41908A //add by tianfeng
struct honmax_lensdrv_platform_data {
	char		*name;
	unsigned int flags;
};

static struct honmax_lensdrv_platform_data honmax_lensdrv_data = {
                .name = "spi_lensdev",    
                .flags	 = 0,     
			  };

static struct spi_board_info  honmax_lensdrv_spi_device[] __initdata = {
	{
		.modalias = "spi_lensdev",
		.max_speed_hz = 1000000, /* max spi clock (SCK) speed in HZ */
		.bus_num = 0,
		.chip_select = 0,
		.mode = 4,
		.platform_data = &honmax_lensdrv_data,
	},
...
{
	//spi_register_board_info(imx6_m636d1_spi_nor_device,
	//			ARRAY_SIZE(imx6_m636d1_spi_nor_device));
#ifdef CONFIG_LENS_AN41908A //add by tianfeng
	printk("tianfeng------> spi device init for honmax lensdrv\n");
	int ret;
	ret = spi_register_board_info(honmax_lensdrv_spi_device, 
				ARRAY_SIZE(honmax_lensdrv_spi_device));

	printk("tianfeng------> spi device init for honmax lensdrv get value = %d\n", ret);
#endif
}

static struct imx_ssi_platform_data mx6_m636d1_ssi_pdata = {
	.flags = IMX_SSI_DMA | IMX_SSI_SYN,
};

static struct platform_device mx6_m636d1_audio_wm8958_device = {
	.name = "imx-wm8958",
};
...
static struct platform_device mx6_m636d1_audio_wm8962_device = {
	.name = "imx-wm8962",
};
...
static struct mxc_audio_platform_data wm8962_data = {
	...
	.src_port = 2,
	.ext_port = 3,
	.hp_gpio = -2,/*-2 means the headphone is always online; -1 means that have no headphone*///SABRESD_HEADPHONE_DET,
	.hp_active_low = 1,
	.mic_gpio = -2,/*-2 means the amic is always online,dmic disable; -1 means that have no amic, and the dmic is enable*///SABRESD_MICROPHONE_DET,
	.mic_active_low = 1,
...
{
	if (cpu_is_mx6q())
		mxc_iomux_v3_setup_multiple_pads(mx6q_m636d1_csi0_sensor_pads,
			ARRAY_SIZE(mx6q_m636d1_csi0_sensor_pads));
...
{
	if (cpu_is_mx6q())
		mxc_iomux_v3_setup_multiple_pads(mx6q_m636d1_mipi_sensor_pads,
			ARRAY_SIZE(mx6q_m636d1_mipi_sensor_pads));
	else if (cpu_is_mx6dl())
...
static struct imxi2c_platform_data mx6q_m636d1_i2c_data = {
	.bitrate = 100000,
};
...
#ifdef CONFIG_MXC_CAMERA_OV5642	
	{
		I2C_BOARD_INFO("ov5642", 0x3c),
		.platform_data = (void *)&camera_data,
	},
#endif
#ifdef CONFIG_MXC_CAMERA_AR03311
	{
		I2C_BOARD_INFO("ar0331", 0x10),
		.platform_data = (void *)&camera_data,
	},
#endif
#ifdef CONFIG_MXC_CAMERA_OV2655
	{
		I2C_BOARD_INFO("ov2655", 0x30),
		.platform_data = (void *)&camera_data,	
	},
#endif
#ifdef CONFIG_MXC_MMA8451	
	{
...
static struct i2c_board_info mxc_i2c2_board_info[] __initdata = {
	...
	{
		I2C_BOARD_INFO("egalax_ts", 0x4),
		.irq = gpio_to_irq(HONMAX_TP_INT),
	},
#endif
#if 0
#ifdef CONFIG_TOUCHSCREEN_FT5X06	
	{/*add by ljc for ft5x0x_ts tp*/
...
#ifdef HONMAX_OTG_ID_CTRL
void honmax_otg_id_ctrl_init(void)
{
	gpio_request(HONMAX_OTG_ID_EN, "otg_id_ctrl");
	gpio_direction_output(HONMAX_OTG_ID_EN,0);
}
void honmax_disable_otg_id(void)
{
	gpio_set_value(HONMAX_OTG_ID_EN,0);
}
void honmax_enable_otg_id(void)
{
	gpio_set_value(HONMAX_OTG_ID_EN,1);
}
#else
void honmax_otg_id_ctrl_init(void)
{
	gpio_request(HONMAX_OTG_ID_EN, "otg_id_ctrl");
	gpio_direction_output(HONMAX_OTG_ID_EN,1);
}
void honmax_disable_otg_id(void)
{
	return;
...
EXPORT_SYMBOL(honmax_enable_otg_id);
EXPORT_SYMBOL(honmax_disable_otg_id);

static void imx6q_m636d1_usbotg_vbus(bool on)
{
	printk("imx6q_m636d1_usbotg_vbus:%d\n",on);
	if (on)
	{
		gpio_set_value(HONMAX_OTG_VBUS_CRTL,1);
...
static void imx6q_m636d1_host1_vbus(bool on)
{
	if (on)
...
static void __init imx6q_m636d1_init_usb(void)
{
	int ret = 0;
	...
	ret=gpio_request(HONMAX_OTG_VBUS_CRTL,"vbus-ctrl");
	if (ret) {
		pr_err("failed to get GPIO HONMAX_OTG_VBUS_CRTL: %d\n",ret);
		return;
	}
	honmax_otg_id_ctrl_init();
	gpio_direction_output(HONMAX_OTG_VBUS_CRTL,1);
...
//	gpio_direction_output(SABRESD_USB_H1_PWR, 1);
	...
	mx6_set_otghost_vbus_func(imx6q_m636d1_usbotg_vbus);
	mx6_set_host1_vbus_func(imx6q_m636d1_host1_vbus);
...
static int mx6q_m636d1_sata_init(struct device *dev, void __iomem *addr)
{
	u32 tmpdata;
	int ret = 0;
	struct clk *clk;
...
static void mx6q_m636d1_sata_exit(struct device *dev)
{
	clk_disable(sata_clk);
	clk_put(sata_clk);
}

static struct ahci_platform_data mx6q_m636d1_sata_data = {
	.init = mx6q_m636d1_sata_init,
	.exit = mx6q_m636d1_sata_exit,
};

static void mx6q_m636d1_flexcan0_switch(int enable)
{
	if (enable) {
...
static const struct flexcan_platform_data
	mx6q_m636d1_flexcan0_pdata __initconst = {
	.transceiver_switch = mx6q_m636d1_flexcan0_switch,
};
...
static void hdmi_enable_ddc_pin(void)
{
	...
	printk("hdmi_enable_dcc_pin\n");
	if (cpu_is_mx6dl())
		mxc_iomux_v3_setup_multiple_pads(mx6dl_sabresd_hdmi_ddc_pads,
			ARRAY_SIZE(mx6dl_sabresd_hdmi_ddc_pads));
	else
		mxc_iomux_v3_setup_multiple_pads(mx6q_m636d1_hdmi_ddc_pads,
			ARRAY_SIZE(mx6q_m636d1_hdmi_ddc_pads));
}

static void hdmi_disable_ddc_pin(void)
{
	printk("hdmi_disable_dcc_pin\n");
	if (cpu_is_mx6dl())
		mxc_iomux_v3_setup_multiple_pads(mx6dl_sabresd_i2c2_pads,
			ARRAY_SIZE(mx6dl_sabresd_i2c2_pads));
	else
		mxc_iomux_v3_setup_multiple_pads(mx6q_m636d1_i2c2_pads,
			ARRAY_SIZE(mx6q_m636d1_i2c2_pads));
}
...
#if 1
#if 0
static struct pad6_battery_state_pin_t battery_state_pin={
	.dc_detect_pin=HONMAX_DC_DETECT,
	.batlow_detect_pin=HONMAX_LOW_POWER,
	.charging_detect_pin=HONMAX_CHARG_STATE_FULL_POWER,
	.batfull_detect_pin=HONMAX_CHARG_STATE_FULL_POWER,
};

static struct pad6_battery_ctrl_pin_t battery_ctrl_pin={
	.max8903_enable_ctrl=HONMAX_MAX8903_CHARG_EN,
	.max8903_charging_ctrl1=HONMAX_MAX8903_CHARG_CTRL1,	
	.max8903_charging_ctrl2=HONMAX_MAX8903_CHARG_CTRL2,
	.usb_charging_ctrl=HONMAX_USB_CHARG_CTRL,
};

static struct pad6_battery_info_t battery_info={
	.state_pin=&battery_state_pin,
	.ctrl_pin=&battery_ctrl_pin,
};

static struct platform_device pad6_battery_dev = {
	.name	= "pad6_battery",
	.id	= 1,
	.dev	= {
...
#else
	gpio_set_value(SABRESD_AUX_5V_EN, 1); /*PAD6 use this pin to control PMIC_5V, this power no need to off when sleep*/
#endif
}
...
static const struct pm_platform_data mx6q_m636d1_pm_data __initconst = {
	.name = "imx_pm",
...
{
	if (board_is_mx6_reva()) {
		mxc_register_device(&mx6_m636d1_audio_wm8958_device,
				    &wm8958_data);
		imx6q_add_imx_ssi(1, &mx6_m636d1_ssi_pdata);

		mxc_wm8958_init();
	} else {
		platform_device_register(&sabresd_vwm8962_reg_devices);
		mxc_register_device(&mx6_m636d1_audio_wm8962_device,
				    &wm8962_data);
		imx6q_add_imx_ssi(1, &mx6_m636d1_ssi_pdata);
...
/*modify by ljc for honmax key*/
#define HONMAX_DEFINE_KEYS
#ifndef HONMAX_DEFINE_KEYS
static struct gpio_keys_button imx6q_buttons[] = {
	GPIO_BUTTON(SABRESD_VOLUME_UP, KEY_VOLUMEUP, 1, "volume-up", 0,0),
	GPIO_BUTTON(SABRESD_VOLUME_DN, KEY_POWER, 1, "volume-down", 1,0),
};
#else
#define HONMAX_MUX_KEYS
 #ifndef HONMAX_MUX_KEYS
static struct gpio_keys_button imx6q_buttons[] = {
	GPIO_BUTTON(SABRESD_VOLUME_UP, KEY_VOLUMEUP, 1, "volume-up", 0,20),
	GPIO_BUTTON(SABRESD_VOLUME_DN, KEY_VOLUMEDOWN, 1, "volume-down", 0,20),
	GPIO_BUTTON(SABRESD_POWER_OFF,KEY_POWER,1,"power-down",1,20),
};
 #else
static struct gpio_keys_button imx6q_buttons[] = {
	GPIO_BUTTON(SABRESD_POWER_OFF,KEY_POWER,1,"power-down",1,20),
 ...
 #endif
#define HONMAX_BUTTON(gpio_num, mux, ev_code, ev_code2, act_low, descr, wake, debounce)	\
{								               \
	.gpio		= gpio_num,				\
	.type		= EV_KEY,				\
	.longpress       =mux,                                      \
...
/*static struct honmax_keys_button honmax_buttons[]={
	HONMAX_BUTTON(SABRESD_VOLUME_UP, true, KEY_BACK, KEY_VOLUMEUP, 1, "volume-up", 0, 20),
	HONMAX_BUTTON(SABRESD_VOLUME_DN, true, KEY_MENU, KEY_VOLUMEDOWN, 1, "volume-up", 0, 20),
};

static struct honmax_keys_platform_data honmax_button_data = {
	.buttons=honmax_buttons,
	.nbuttons=ARRAY_SIZE(honmax_buttons),
};

static struct platform_device honmax_button_device = {
	.name="honmax-keys",
	.id=-1,
	.num_resources=0,
	.dev={
		.platform_data = &honmax_button_data,
	}
}; */
 #endif
#endif
...
//#ifdef HONMAX_MUX_KEYS 	
//	platform_device_register(&honmax_button_device);
//#endif	
//}
//#else
static void __init imx6q_add_device_buttons(void) {}
...
static struct platform_pwm_backlight_data mx6_m636d1_pwm_backlight_data = {
	.pwm_id = 0,
	.max_brightness = 248,
	.dft_brightness = 128,
	.pwm_period_ns = 50000,
...
static const struct imx_pcie_platform_data mx6_m636d1_pcie_data __initconst = {
...
//extern int mx6q_pad6_register_power(void);

static void __init mx6_m636d1_board_init(void)
{
	int i;
	int ret;
	...
	int rate;
	printk("yzw==>mx6_m636d1_board_init\n");
	if (cpu_is_mx6q())
		mxc_iomux_v3_setup_multiple_pads(mx6q_m636d1_pads,
			ARRAY_SIZE(mx6q_m636d1_pads));
	else if (cpu_is_mx6dl()) {
	...
	//honmax_gpio_init(); /*Add by ljc for Honmax GPIO common init*/
	//platform_device_register(&watch_pa306_dev);/*add by ljc for watch pa306*/
//	gpio_request(HONMAX_NOTE_REBOOT, "note_reboot");
//	gpio_direction_output(HONMAX_NOTE_REBOOT,1);
//	gpio_request(HONMAX_LOCK_POWER,"lock_power");
//	gpio_direction_output(HONMAX_LOCK_POWER,1);
...
//	imx6q_add_imx_i2c(0, &mx6q_m636d1_i2c_data);
	imx6q_add_imx_i2c(1, &mx6q_m636d1_i2c_data);
	imx6q_add_imx_i2c(2, &mx6q_m636d1_i2c_data);
...
//			ARRAY_SIZE(mxc_i2c0_board_info));
	...
	if (ret) {
		...
		mx6q_m636d1_init_pfuze100(SABRESD_PFUZE_INT);
	}
#else
//	mx6q_pad6_register_power();
#endif
	
	/* SPI */
	//imx6q_add_ecspi(0, &mx6q_m636d1_spi_data);
	//spi_device_init(); //------->M2031
	//spi_device_init();

	imx6q_add_mxc_hdmi(&hdmi_data);

	imx6q_add_anatop_thermal_imx(1, &mx6q_m636d1_anatop_thermal_data);
	imx6_init_fec(fec_data);
	imx6q_add_pm_imx(0, &mx6q_m636d1_pm_data);

	/* Move sd4 to first because sd4 connect to emmc.
	   Mfgtools want emmc is mmcblk0 and other sd card is mmcblk1.
	*/
#ifdef CONFIG_BOOT_FROM_SD
	imx6q_add_sdhci_usdhc_imx(2, &mx6q_m636d1_sd3_data);
	imx6q_add_sdhci_usdhc_imx(3, &mx6q_m636d1_sd4_data); 
#else
	imx6q_add_sdhci_usdhc_imx(3, &mx6q_m636d1_sd4_data);
	imx6q_add_sdhci_usdhc_imx(2, &mx6q_m636d1_sd3_data);
#endif
	//imx6q_add_sdhci_usdhc_imx(3, &mx6q_m636d1_sd4_data);
	//imx6q_add_sdhci_usdhc_imx(1, &mx6q_m636d1_sd2_data);
	//imx6q_add_sdhci_usdhc_imx(2, &mx6q_m636d1_sd3_data);
	imx_add_viv_gpu(&imx6_gpu_data, &imx6q_gpu_pdata);
	
	imx6q_m636d1_init_usb();
	
	/* SATA is not supported by MX6DL/Solo */
	if (cpu_is_mx6q())
		imx6q_add_ahci(0, &mx6q_m636d1_sata_data);
	imx6q_add_vpu();
	imx6q_init_audio();
...
#endif
	//gpio_request(SABRESD_CABC_EN1, "cabc-en1"); //we have no this display port and backlight
	//gpio_direction_output(SABRESD_CABC_EN1, 0);   //we have no this display port and backlight

	imx6q_add_mxc_pwm(0);
	imx6q_add_mxc_pwm(1);
	imx6q_add_mxc_pwm(2);
	imx6q_add_mxc_pwm(3);
	//imx6q_add_mxc_pwm_backlight(0, &mx6_m636d1_pwm_backlight_data);
...
#if 0 /*we have no use max17135 and epdc*/
	if (cpu_is_mx6dl()) {
		imx6dl_add_imx_pxp();
...
#endif 	
	/*
	ret = gpio_request_array(mx6q_m636d1_flexcan_gpios,
			ARRAY_SIZE(mx6q_m636d1_flexcan_gpios));
	if (ret)
		pr_err("failed to request flexcan1-gpios: %d\n", ret);
	else
		imx6q_add_flexcan0(&mx6q_m636d1_flexcan0_pdata);
	*/
...
#else
	/*Register pad6 battery dev*/
	//platform_device_register(&pad6_battery_dev);
#endif
	pm_power_off = mx6_snvs_poweroff;
	imx6q_add_busfreq();

	/* Add PCIe RC interface support */
//	imx6q_add_pcie(&mx6_m636d1_pcie_data);
	if (cpu_is_mx6dl()) {
...
//	gpio_request(HONMAX_LED_1, "led-1");
//	gpio_direction_output(HONMAX_LED_1, 0);
//	gpio_request(HONMAX_LED_2, "led-2");
//	gpio_direction_output(HONMAX_LED_2, 0);
...
#ifdef CONFIG_MXC_PXP_CLIENT_DEVICE
       platform_device_register(&pxp_client_dev);
#endif
}

extern void __iomem *twd_base;
static void __init mx6_m636d1_timer_init(void)
{
	struct clk *uart_clk;
...
static struct sys_timer mx6_m636d1_timer = {
	.init   = mx6_m636d1_timer_init,
};

static void __init mx6q_m636d1_reserve(void)
{
...
/*
 * initialize __mach_desc_mx6q_m636d1 data structure.
 */
MACHINE_START(MX6Q_M636D1, "HONMAX M636D1")
	/* Maintainer: Freescale Semiconductor, Inc. */
	.boot_params = MX6_PHYS_OFFSET + 0x100,
	.fixup = fixup_mxc_board,
	.map_io = mx6_map_io,
	.init_irq = mx6_init_irq,
	.init_machine = mx6_m636d1_board_init,
	.timer = &mx6_m636d1_timer,
	.reserve = mx6q_m636d1_reserve,
MACHINE_END
